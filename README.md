...
1 - Connect to EC2 instance and run command above to create a cluster. This command can to take about 15 minutos to finish.<br/>
...
3 - Finally, let's get information of the cluster using <code>kubectl</code>.<br/>
